...
for($h = 0; $h < count($heavenBuildings); $h++) {
  $countHeaven = checkIfIsZoneHell($countHeaven,$hellBuildings[$h]);
}
...
else $time = 60/(($countHell * $altar->ProductionPerBuildingHell) + ($countHeaven*$altar->ProductionPerBuildingHeaven));
